...
--
--
-- ALTER TABLE questionnaire OWNER TO postgres;
--
--
...
--
--
-- ALTER TABLE questionnaire ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- ALTER TABLE ONLY questionnaire_question
--     ADD CONSTRAINT fk4n8eq0srwbjxack3qoqcuqx76 FOREIGN KEY (questionnaire_id) REFERENCES questionnaire(id);
--
-- ALTER TABLE ONLY question_condition
...
--
-- ALTER TABLE ONLY questionnaire_answer
--     ADD CONSTRAINT fkhtx1papwptykmkwkhat3fn0v1 FOREIGN KEY (questionnaire_id) REFERENCES questionnaire(id);
--
--
-- ALTER TABLE ONLY question_code_label
