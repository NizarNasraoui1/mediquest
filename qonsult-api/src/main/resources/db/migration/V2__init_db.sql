...
--
-- ALTER TABLE ONLY users
--     ADD CONSTRAINT fkejqbue1tvvj4wdlfs6w0q1py7 FOREIGN KEY (role_id) REFERENCES group(id);
--
--
-- ALTER TABLE ONLY questionnaire_answer
...
--     ADD CONSTRAINT fkkpnbyr8mw3otveld1ufyfl8cr FOREIGN KEY (premission_id) REFERENCES role(id);
--
--
--
-- ALTER TABLE ONLY questionnaire_answer
...
--
-- ALTER TABLE ONLY roles_permission
--     ADD CONSTRAINT fktjf5ade20d1jhapaijxgwrvcv FOREIGN KEY (role_id) REFERENCES group(id);
--
